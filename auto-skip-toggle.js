...
(async function AutoSkipPro() {
    while (!Spicetify?.Player || !Spicetify?.showNotification || !Spicetify?.Tippy) {
    ...
    btn.addEventListener("contextmenu", (e) => {
        ...
        Spicetify.showNotification(`Auto-Skip Speed: ${isFast ? "FAST (0.5s)" : "SAFE (1.5s)"}`);
    });
